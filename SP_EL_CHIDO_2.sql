    ...
    ELSE IF (@IP_WSS_CUENTA = 'TRUE' AND @APAGA_JSON = 'TRUE')         
        ...
        --********************************
            ...
            BEGIN
                ...
                IF @Cont = 1
                BEGIN
                        SET @REG1 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta)
                END
                
                IF @Cont = 2
                BEGIN
                        SET @REG2 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta)
                END
                
                IF @Cont = 3
                BEGIN
                        SET @REG3 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta)
                END
                IF @Cont = 4
                BEGIN
                        SET @REG4 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                IF @Cont =  5
                BEGIN
                        SET @REG5 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                IF @Cont = 6
                BEGIN
                        SET @REG6 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 7
                BEGIN
                    SET @REG7 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 8
                BEGIN
                        SET @REG8 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 9
                BEGIN
                        SET @REG9 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 10
                BEGIN
                        SET @REG10 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 11
                BEGIN
                        SET @REG11 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 12
                BEGIN
                        SET @REG12 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 13
                BEGIN
                        SET @REG13 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 14
                BEGIN
                        SET @REG14 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                IF @Cont = 15
                BEGIN
                        SET @REG15 = RTRIM(isnull(@403,' , , , ,9, '))+RTRIM(isnull(@008_041_140,' , , , , , , , , '))+RTRIM(@Cuenta) 
                END
                
                SET @Cont = @Cont + 1
                
                FETCH NEXT FROM CuentasCursor INTO @Cuenta--,@DatOp,@NumOperacion
