      ...
      *
           PERFORM ACCESO-TC9C9900
      *@BAZ038 - I
           PERFORM CONSULTA-PARAM-DIGITALES
      *@BAZ038 - F
      *@BAZ056-I
           IF CAA-CEN-ACCOUNT = CA-1156 AND
              CAA-CHANN = CA-54
              PERFORM 1100-VAL-USUADIO-SAPP
           END-IF
      *@BAZ056-F
           .
      *@BAZ056-I
      ...
      ******************************************************************
       20000-PROCESO.
      *
           PERFORM 21000-VALIDA-ENTRADA
           PERFORM 22000-CALCULA-FECHA
      *@BAZ037-I
      *@BAZ070-I
           PERFORM 22000-LLAMADO-SP
      *
           IF WSS-CUENTA AND SW-APAGA-JSON
              PERFORM 23000-EXTRAE-DATOS-X-STORED
           ELSE
              IF SW-PRENDE-JSON  AND (WSS-CUENTA OR WSS-CUENTA-710)
                 PERFORM 23000-EXTRAE-DATOS-X-SP-JSON
              END-IF
           END-IF
      *@BAZ070-F
      *
           IF WSS-RET-CTA
               PERFORM 24000-EXTRAE-DATOS-X-STORED-RET
           END-IF
      *@BAZ037-F
      *@BAZ0005.I
      *@BAZ021-INI
      ...
      *@BAZ052-I
                            PERFORM  23300-SUMA-SOBRES
                            PERFORM  23400-SUMA-ALCANCIA
