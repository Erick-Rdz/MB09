...
GO
ALTER PROCEDURE [MAZP].[MB09_MB2CF119_v4]
...
SET ANSI_WARNINGS ON
      ...
      DECLARE @NUMOPE DECIMAL= CAST(SUBSTRING(@ULLAVE,11,10)AS DECIMAL)
      DECLARE @FECAFIN CHAR(10) =SUBSTRING(@ULLAVE,1,10)   
      ...
      SELECT TOP 15 
        ...
        LEFT JOIN MAZP.MCDT803 AS D with(nolock) ON
            ...
            WHERE A.T071_ACC = @COD_PROD+@NUM_ACC                  AND 
                  ...
                  A.T071_DAT_OPERATION BETWEEN @FECHA AND @FECAFIN AND 
				  A.T071_NUM_OPERATION < @NUMOPE                   AND
